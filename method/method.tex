...
The Zeeman shift values from the previous part are plotted agains a linear fit. We graph the best fit relationship between the Zeeman split separation and the magnetic field, and evaluate the goodness of fit criteria to determine how well the linear model matches the experimental results.
