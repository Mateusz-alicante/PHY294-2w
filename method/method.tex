...
We calculate this relationship based on equation \ref{eq:em_relationship}.
First we obtain the average line separation for all of the measured lines, and then we use
the slope of the line obtained in the previous part to approximate $\frac{\Delta S}{B}$
