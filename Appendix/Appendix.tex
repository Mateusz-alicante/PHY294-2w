...
\begin{table}[H]
    \begin{adjustwidth}{-100pt}{-100pt}
        ...
        \end{tabular}
    \end{adjustwidth}
    \caption{Zeeman shift measurments in mm for trial 1: 4A current}
\end{table}
...
\begin{table}[H]
    ...
    \caption{Zeeman shift measurments in mm for trial 2: 6A current}
...
\begin{table}[H]
    ...
    \caption{Zeeman shift measurments in mm for trial 3: 12A current}
...
\begin{table}[H]
    ...
    \caption{Zeeman shift measurments in mm for trial 4: 14A current}
...
\begin{table}[H]
    ...
    \caption{Zeeman shift measurements in mm for trial 5: 16A current}
...
This appendix contains the calculations for the uncertainty propagation in the experiment.
...
The linear fit and the variance calculation is done with help of the Python package SciPy \cite{gommers2022scipy}.

\subsubsection{Part 3: Measuring the $\frac{e}{m}$ relationship}

The individual measurements of the position of the lines without a magnetic field have uncertainty of the precision of the instrument used:
