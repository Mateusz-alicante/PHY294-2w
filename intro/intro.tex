...
We will also expore how the emitted light is polarized when the magnetic field is applied. Figure \cite{ZeemanEffectLab} shows the polarization scheme for the emitted light for different electronic transitions.
