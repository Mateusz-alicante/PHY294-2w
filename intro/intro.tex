...
We can then use the change in frequency to estimate the value of $\frac{e}{m}$ by using $c = \nu \lambda$:

\begin{equation}
    \frac{e}{m} = 4 \pi \frac{\Delta \nu}{B} = 4 \pi \frac{\Delta c}{B \Delta \lambda} =
    \frac{4 \pi c}{B} \frac{\Delta A 2d \sqrt[2]{\eta^2 - 1}}{2 \Delta S \lambda^2}
\end{equation}